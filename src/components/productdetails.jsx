...
const productdetails = () => {
  ...
  <div className="d-flex">
    ...
    <div className="col-6 card p-3">
        ...
        <p className='mb-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus sequi suscipit voluptas enim doloremque adipisci quasi iusto molestias ratione ipsum, dolorem similique at reprehenderit itaque reiciendis? Commodi saepe non quae.</p>
        </div>
